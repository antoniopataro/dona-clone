 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(E,$){var O=E.length;E.push($);e:for(;0<O;){var b=O-1>>>1,P=E[b];if(0<o(P,$))E[b]=$,E[O]=P,O=b;else break e}}function n(E){return E.length===0?null:E[0]}function r(E){if(E.length===0)return null;var $=E[0],O=E.pop();if(O!==$){E[0]=O;e:for(var b=0,P=E.length,N=P>>>1;b<N;){var _=2*(b+1)-1,F=E[_],g=_+1,V=E[g];if(0>o(F,O))g<P&&0>o(V,F)?(E[b]=V,E[g]=O,b=g):(E[b]=F,E[_]=O,b=_);else if(g<P&&0>o(V,O))E[b]=V,E[g]=O,b=g;else break e}}return $}function o(E,$){var O=E.sortIndex-$.sortIndex;return O!==0?O:E.id-$.id}if(typeof performance=="object"&&typeof performance.now=="function"){var i=performance;e.unstable_now=function(){return i.now()}}else{var l=Date,u=l.now();e.unstable_now=function(){return l.now()-u}}var s=[],c=[],h=1,p=null,m=3,x=!1,y=!1,w=!1,R=typeof setTimeout=="function"?setTimeout:null,d=typeof clearTimeout=="function"?clearTimeout:null,a=typeof setImmediate!="undefined"?setImmediate:null;typeof navigator!="undefined"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function f(E){for(var $=n(c);$!==null;){if($.callback===null)r(c);else if($.startTime<=E)r(c),$.sortIndex=$.expirationTime,t(s,$);else break;$=n(c)}}function v(E){if(w=!1,f(E),!y)if(n(s)!==null)y=!0,yt(k);else{var $=n(c);$!==null&&Le(v,$.startTime-E)}}function k(E,$){y=!1,w&&(w=!1,d(I),I=-1),x=!0;var O=m;try{for(f($),p=n(s);p!==null&&(!(p.expirationTime>$)||E&&!me());){var b=p.callback;if(typeof b=="function"){p.callback=null,m=p.priorityLevel;var P=b(p.expirationTime<=$);$=e.unstable_now(),typeof P=="function"?p.callback=P:p===n(s)&&r(s),f($)}else r(s);p=n(s)}if(p!==null)var N=!0;else{var _=n(c);_!==null&&Le(v,_.startTime-$),N=!1}return N}finally{p=null,m=O,x=!1}}var T=!1,L=null,I=-1,W=5,M=-1;function me(){return!(e.unstable_now()-M<W)}function fe(){if(L!==null){var E=e.unstable_now();M=E;var $=!0;try{$=L(!0,E)}finally{$?we():(T=!1,L=null)}}else T=!1}var we;if(typeof a=="function")we=function(){a(fe)};else if(typeof MessageChannel!="undefined"){var We=new MessageChannel,Ne=We.port2;We.port1.onmessage=fe,we=function(){Ne.postMessage(null)}}else we=function(){R(fe,0)};function yt(E){L=E,T||(T=!0,we())}function Le(E,$){I=R(function(){E(e.unstable_now())},$)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(E){E.callback=null},e.unstable_continueExecution=function(){y||x||(y=!0,yt(k))},e.unstable_forceFrameRate=function(E){0>E||125<E?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):W=0<E?Math.floor(1e3/E):5},e.unstable_getCurrentPriorityLevel=function(){return m},e.unstable_getFirstCallbackNode=function(){return n(s)},e.unstable_next=function(E){switch(m){case 1:case 2:case 3:var $=3;break;default:$=m}var O=m;m=$;try{return E()}finally{m=O}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(E,$){switch(E){case 1:case 2:case 3:case 4:case 5:break;default:E=3}var O=m;m=E;try{return $()}finally{m=O}},e.unstable_scheduleCallback=function(E,$,O){var b=e.unstable_now();switch(typeof O=="object"&&O!==null?(O=O.delay,O=typeof O=="number"&&0<O?b+O:b):O=b,E){case 1:var P=-1;break;case 2:P=250;break;case 5:P=1073741823;break;case 4:P=1e4;break;default:P=5e3}return P=O+P,E={id:h++,callback:$,priorityLevel:E,startTime:O,expirationTime:P,sortIndex:-1},O>b?(E.sortIndex=O,t(c,E),n(s)===null&&E===n(c)&&(w?(d(I),I=-1):w=!0,Le(v,O-b))):(E.sortIndex=P,t(s,E),y||x||(y=!0,yt(k))),E},e.unstable_shouldYield=me,e.unstable_wrapCallback=function(E){var $=m;return function(){var O=m;m=$;try{return E.apply(this,arguments)}finally{m=O}}}})(Qa);Wa.exports=Qa;/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Rh=D.exports,Th=Symbol.for("react.element"),Ih=Symbol.for("react.fragment"),_h=Object.prototype.hasOwnProperty,zh=Rh.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,Lh={key:!0,ref:!0,__self:!0,__source:!0};function Yd(e,t,n){var r,o={},i=null,l=null;n!==void 0&&(i=""+n),t.key!==void 0&&(i=""+t.key),t.ref!==void 0&&(l=t.ref);for(r in t)_h.call(t,r)&&!Lh.hasOwnProperty(r)&&(o[r]=t[r]);if(e&&e.defaultProps)for(r in t=e.defaultProps,t)o[r]===void 0&&(o[r]=t[r]);return{$$typeof:Th,type:e,key:i,ref:l,props:o,_owner:zh.current}}pi.Fragment=Ih;pi.jsx=Yd;pi.jsxs=Yd;fi.exports=pi;const C=fi.exports.jsx,X=fi.exports.jsxs,Dh=fi.exports.Fragment,hi=D.exports.createContext({}),$h={name:""};function Oh({children:e}){const t=JSON.parse(localStorage.getItem("userPreferencesDonaClone")||JSON.stringify($h)),[n,r]=D.exports.useState(t),o=i=>{r(l=>({...l,name:i}))};return D.exports.useEffect(()=>{localStorage.setItem("userPreferencesDonaClone",JSON.stringify(n))},[n]),C(hi.Provider,{value:{user:n,registerUser:o},children:e})}const Br=D.exports.createContext({}),Fh=[{taskAmout:0,title:"Home",slug:"/",color:"008FFD"}];function Mh({children:e}){const t=JSON.parse(localStorage.getItem("userCategoriesDonaClone")||JSON.stringify(Fh)),[n,r]=D.exports.useState(t),o=u=>{r(s=>[...s,u])},i=u=>{r(s=>s.filter(c=>c.slug!==u))},l=(u,s)=>{r(c=>c.map(h=>h.slug===u?{...h,color:s}:h))};return D.exports.useEffect(()=>{localStorage.setItem("userCategoriesDonaClone",JSON.stringify(n))},[n]),C(Br.Provider,{value:{categories:n,addCategory:o,removeCategory:i,updateCategoryColor:l},children:e})}const mi=D.exports.createContext({});function jh({children:e}){const t="/",[n,r]=D.exports.useState(t),o=i=>{r(i)};return C(mi.Provider,{value:{path:n,changePath:o},children:e})}const gi=D.exports.createContext({});function Uh({children:e}){const t=JSON.parse(localStorage.getItem("userTasksDonaClone")||"[]"),[n,r]=D.exports.useState(t),o=u=>{r(s=>[...s,u])},i=u=>{r(s=>s.filter(c=>c.id!==u))},l=(u,s)=>{r(c=>c.map(h=>h.id===u.id?{...u,checked:s}:h))};return D.exports.useEffect(()=>{localStorage.setItem("userTasksDonaClone",JSON.stringify(n))},[n]),C(gi.Provider,{value:{tasks:n,addTask:o,removeTask:i,updateCheckedStatus:l},children:e})}function Gd(e,t){D.exports.useEffect(()=>{const n=r=>{!e.current||e.current.contains(r.target)||t()};return document.addEventListener("mousedown",n),document.addEventListener("touchstart",n),()=>{document.removeEventListener("mousedown",n),document.removeEventListener("touchstart",n)}},[e,t])}var ls={exports:{}},J={};/**
 * @license React
...
`,V0=["0564A4","0C8FF1","0ABAFA","0BB8AA","00B873","DDBC10","FCF7BD","FF705D","F8003C","BE0A19","B90F8B","F56ED8","7E45F7","4A40EE","94959F","7B7168"];function H0({setColor:e,isSelectingColor:t,setIsSelectingColor:n}){const[r,o]=D.exports.useState("008FFD"),[i,l]=D.exports.useState(),u=()=>{if(!t){l({animation:"colorPickerSlideDown .25s ease forwards"});return}s()},s=()=>{l({animation:"colorPickerSlideUp .25s ease forwards"}),setTimeout(()=>{n(!1)},250)},c=D.exports.useRef(null);Gd(c,u);function h(p,m){m==null||m.preventDefault(),e(p),u()}return D.exports.useEffect(()=>{r===""&&o("008FFD")},[r]),C(B0,{theme:hn,isSelectingColor:t,ref:c,style:{...i},children:t&&X(Dh,{children:[C("h4",{children:"Colors"}),C("div",{className:"colors",children:C("ul",{children:V0.map(p=>C("li",{onClick:()=>h(p),children:C("svg",{width:"15",height:"15",viewBox:"0 0 15 15",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:C("rect",{x:"1.25",y:"1.25",width:"12.5",height:"12.5",rx:"4.75",stroke:`#${p}`,fill:`#${p}`,strokeWidth:"2.5"})})},p))})}),X("div",{id:"custom-color-wrapper",children:[C("h4",{children:"Custom color"}),X("div",{id:"custom-color",children:[C("svg",{width:"15",height:"15",viewBox:"0 0 15 15",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:C("rect",{x:"1.25",y:"1.25",width:"12.5",height:"12.5",rx:"4.75",stroke:`#${r}`,fill:`#${r}`,strokeWidth:"2.5"})}),C("form",{noValidate:!0,onSubmit:p=>h(r,p),children:C("input",{type:"text",placeholder:r,onChange:p=>o(p.target.value)})})]})]})]})})}var sf="/dona-clone/assets/removeIcon.63e204af.svg";const W0=qt.a`
  display: flex;
  flex-direction: row;
...
`;function Q0({category:e}){const{removeCategory:t,updateCategoryColor:n}=D.exports.useContext(Br),{path:r,changePath:o}=D.exports.useContext(mi),{tasks:i,removeTask:l}=D.exports.useContext(gi),[u,s]=D.exports.useState(""),[c,h]=D.exports.useState("008FFD"),[p,m]=D.exports.useState(""),[x,y]=D.exports.useState(!1);function w(v,k){k.stopPropagation(),v!=="/"&&(R(v),o("/"))}const R=v=>{s(v),setTimeout(()=>{t(v),d(v)},250)},d=v=>{i.forEach(k=>k.category.slug===v?l(k.id):"")};function a(v,k){k.stopPropagation(),y(!x),m(v)}D.exports.useEffect(()=>{n(p,c)},[c]);const f=i.filter(v=>v.category.slug===e.slug).length;return X(W0,{theme:hn,beingRemoved:u===e.slug,activeCategory:e.slug===r,onClick:()=>o(e.slug),children:[X("div",{className:"left",children:[C("span",{onClick:v=>a(e.slug,v),children:C("svg",{width:"15",height:"15",viewBox:"0 0 15 15",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:C("rect",{x:"1.25",y:"1.25",width:"12.5",height:"12.5",rx:"4.75",stroke:`#${e.color}`,strokeWidth:"2.5"})})}),C("h3",{children:e.title}),C(H0,{setColor:h,isSelectingColor:x,setIsSelectingColor:y})]}),X("span",{className:"task-amout",children:[C("h4",{children:f}),e.slug!=="/"&&C("button",{className:"remove-category",onClick:v=>w(e.slug,v),children:C("img",{src:sf,alt:"Remove Category",width:12})})]})]})}function af(e){const t=D.exports.useCallback(n=>{const r=n.key.toLowerCase(),o=n.ctrlKey;e.forEach(i=>{o===i.ctrlKey&&r===i.key.toLowerCase()&&(n.preventDefault(),i.handler())})},[]);D.exports.useEffect(()=>(document.addEventListener("keydown",n=>t(n)),()=>{document.removeEventListener("keydown",n=>t(n))}),[t])}var Y0="/dona-clone/assets/addIcon.408931b1.svg";const G0=qt.aside`
  position: relative;
...
`;function nm({task:e}){const{removeTask:t,updateCheckedStatus:n}=D.exports.useContext(gi),[r,o]=D.exports.useState(""),[i,l]=D.exports.useState(e.checked);function u(c){o(c),s(c)}const s=c=>{setTimeout(()=>{t(c)},250)};return D.exports.useEffect(()=>{n(e,i)},[i]),X(tm,{theme:hn,beingRemoved:r===e.id,checked:e.checked,children:[X("div",{className:"left",children:[X("label",{children:[C("input",{type:"checkbox",defaultChecked:i,onChange:()=>l(!i)}),C("div",{className:"checkbox-div"})]}),C("h3",{children:e.content})]}),X("div",{className:"right",children:[C("h4",{className:"date",children:`${e.date.split(" ")[1]} ${e.date.split(" ")[2]}`}),C("svg",{width:"15",height:"15",viewBox:"0 0 15 15",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:C("rect",{x:"1.25",y:"1.25",width:"12.5",height:"12.5",rx:"4.75",stroke:`#${e.category.color}`,strokeWidth:"2.5"})}),C("button",{onClick:()=>u(e.id),children:C("img",{src:sf,alt:"",width:15})})]})]})}var rm="/dona-clone/assets/checkIcon.97d19678.svg";const om=qt.div`
...
`;function im({isSelectingCategory:e,setIsSelectingCategory:t,category:n,setCategory:r}){const{categories:o}=D.exports.useContext(Br),i=D.exports.useRef(null);return Gd(i,()=>t(!1)),C(om,{theme:hn,isSelectingCategory:e,ref:i,children:e&&C("ul",{children:o.map(l=>X("li",{onClick:()=>r(l),children:[C("svg",{width:"15",height:"15",viewBox:"0 0 15 15",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:C("rect",{x:"1.25",y:"1.25",width:"12.5",height:"12.5",rx:"4.75",stroke:`#${l.color}`,strokeWidth:"2.5"})}),C("h4",{children:l.title}),n.slug===l.slug&&C("img",{src:rm,alt:"Chosen Category",width:10,id:"checkmark"})]},l.slug))})})}var lm="/dona-clone/assets/donaBlue.4a2239b6.svg";const um=qt.main`
  display: flex;
  flex-direction: column;
...
`;function wm(){const{user:e}=D.exports.useContext(hi);return X(ym,{theme:hn,children:[C(K0,{}),C(fm,{}),!e.name&&C(vm,{})]})}function xm({children:e}){return C(Mh,{children:C(Uh,{children:C(jh,{children:C(Oh,{children:e})})})})}hl.createRoot(document.getElementById("root")).render(C(Or.StrictMode,{children:C(xm,{children:C(wm,{})})}));
